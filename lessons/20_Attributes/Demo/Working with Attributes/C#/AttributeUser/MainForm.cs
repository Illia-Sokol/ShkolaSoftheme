...
namespace AttributeUser
{
    ...
    private ListBox ItemsToProcessListBox;
    private Button ProcessItemsButton;
		/// <summary>
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ProcessItemsButton_Click(object sender, EventArgs e)
    {
      ...
      string traceLogSetting = ConfigurationManager.AppSettings["TraceLog"];
      ...
      if (MessageBox.Show(this, "Would you like to see the trace log?", 
        ...
        Process.Start(new ProcessStartInfo("notepad.exe", traceLog));
    }
	}
}
